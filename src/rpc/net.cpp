        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::STR_HEX, "block1hash", /*optional=*/true, "The peer's block1hash (chain identifier) if available"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    for (const CNodeStats& stats : vstats) {
        ...
        // Show peer's block1hash if available (new protocol extension)
        if (!stats.m_block1hash.IsNull()) {
            obj.pushKV("block1hash", stats.m_block1hash.ToString());
        }
