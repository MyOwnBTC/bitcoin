...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info)
{
    ...
    if (success) {
        ...
        // Display warning dialog after window is shown
        QTimer::singleShot(500, [this] {
            window->message(CLIENT_NAME " Warning", 
                           "⛔ WARNING: This is potentially NOT the Original Bitcoin Canonical Mainnet!!!\n\n"
                           "Please verify you are running the correct Bitcoin software before proceeding with any transactions.", 
...
int GuiMain(int argc, char* argv[])
{
    ...
    // WARNING: Display startup warning to console
    tfm::format(std::cerr, "⛔ WARNING: This is potentially NOT the Original Bitcoin Canonical Mainnet!!!\n");
    ...
    // WARNING: Display shutdown warning to console
    tfm::format(std::cerr, "⛔ WARNING: This is potentially NOT the Original Bitcoin Canonical Mainnet!!!\n");
